...
layouts =
{
    ...
    awful.layout.suit.fair,                 -- 12
    awful.layout.suit.fair.horizontal       -- 13
}
...
-- Colours
coldef  = "</span>"
colwhi  = "<span color='#259392'>"
colbwhi = "<span color='#ffffff'>"
blue = "<span color='#268bd2'>"
yellow = "<span color='#b58900'>"
purple = "<span color='#6c71c4'>"
lightpurple = "<span color='#d33682'>"
azure = "<span color='#268bd2'>"
green = "<span color='#859900'>"
lightgreen = "<span color='#62b786'>"
red = "<span color='#dc322f'>"
orange = "<span color='#cb4b16'>"
...
mytextclock = awful.widget.textclock("<span color='#74F476'>%A %d %B</span> " .. blue .. "</span><span color=\"#74F476\">></span> <span color='#74F476'>%H:%M</span> ")
...
today_color = theme.fg_focus or "#74F476"
calendar_width = 21
...
tempicon:buttons(awful.util.table.join(
   ...
   vicious.register(tempwidget, vicious.widgets.thermal, "<span color=\"#8aa72d\">$1°C</span>", 9, {"coretemp.0", "core"} )
...
function(widget, args)
	...
	if (args["{state}"] == "Play") then
		return blue .. args["{Title}"] .. coldef .. blue .. " - " .. coldef .. yellow  .. 
		args["{Artist}"] .. coldef
	-- pause
	elseif (args["{state}"] == "Pause") then
		return blue .. "mpd</span>" .. colwhi .." paused</span>"
	-- stop
	elseif (args["{state}"] == "Stop") then
		return blue .. "mpd</span>" .. colwhi .." stopped</span>"
	-- not running
	else
		return blue .. "mpd</span>" .. colwhi .." off</span>"
	end
	end, 1)
...
for s = 1, screen.count() do
    ...
    mybottomwibox[s] = awful.wibox({ position = "bottom", screen = s, border_width = 0, height = 40 })
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey }, "p", function() menubar.show()awful.util.spawn("screenshot",false) end),

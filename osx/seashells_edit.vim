" =============================================================================
" Filename: autoload/lightline/colorscheme/seashells_edit.vim
" Author: deneshshan 
" License: MIT License
" Last Change: 2017/01/14 10:04:03.
" =============================================================================
...
let s:p.tabline.middle = [ [ s:base01, s:blue ] ]
let s:p.tabline.right = copy(s:p.normal.right)
let s:p.normal.error = [ [ s:base2, s:red ] ]
let s:p.normal.warning = [ [ s:base02, s:yellow ] ]

let g:lightline#colorscheme#seashells_edit#palette = lightline#colorscheme#flatten(s:p)
